/**
 * Created by Rayr Lee on 2016/6/7.
 */

var apiURL = 'https://api.github.com/repos/vuejs/vue/commits?per_page=3&sha='
var isPhantom = navigator.userAgent.indexOf('PhantomJS') > -1  //判断是否存在
...
var demo = new Vue({
    ...
    watch: {
        currentBranch: 'fetchData' //响应fetchData 刷新视图
    },
    ...
    filters: {                                       //过滤器
        ...
        formatDate: function (v) {
            return v.replace(/T|Z/g, ' ') //替换T Z为空
        }
    },

    methods: {
        fetchData: function () {                            //取数据
            // CasperJS fails at cross-domain XHR even with
            // --web-security=no, have to mock data here.
            if (isPhantom) {
                return mockData.call(this)             //绑定上下文
            }
